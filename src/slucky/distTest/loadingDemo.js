(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("./doc/loading.md"), require("react"), require("react-dom/server"), require("react-highlight"), require("react-markdown"), require("slucky/src/component/progress"));
	else if(typeof define === 'function' && define.amd)
		define(["./doc/loading.md", "react", "react-dom/server", "react-highlight", "react-markdown", "slucky/src/component/progress"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("./doc/loading.md"), require("react"), require("react-dom/server"), require("react-highlight"), require("react-markdown"), require("slucky/src/component/progress")) : factory(root["./doc/loading.md"], root["react"], root["react-dom/server"], root["react-highlight"], root["react-markdown"], root["slucky/src/component/progress"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(window, function(__WEBPACK_EXTERNAL_MODULE__doc_loading_md__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_dom_server__, __WEBPACK_EXTERNAL_MODULE_react_highlight__, __WEBPACK_EXTERNAL_MODULE_react_markdown__, __WEBPACK_EXTERNAL_MODULE_slucky_src_component_progress__) {
