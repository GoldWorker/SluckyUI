(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("./component/checkbox"), require("./component/curmb"), require("./component/dialog"), require("./component/input"), require("./component/menu"), require("./component/paging"), require("./component/radio"), require("./component/search"), require("./component/select"), require("./component/slidebar"), require("./component/steps"), require("./component/switch"), require("./component/tab"), require("./component/table"), require("./component/testarea"), require("./component/toast"), require("./component/transfrom3D"), require("./lib/validator"));
	else if(typeof define === 'function' && define.amd)
		define(["./component/checkbox", "./component/curmb", "./component/dialog", "./component/input", "./component/menu", "./component/paging", "./component/radio", "./component/search", "./component/select", "./component/slidebar", "./component/steps", "./component/switch", "./component/tab", "./component/table", "./component/testarea", "./component/toast", "./component/transfrom3D", "./lib/validator"], factory);
	else if(typeof exports === 'object')
		exports["slucky"] = factory(require("./component/checkbox"), require("./component/curmb"), require("./component/dialog"), require("./component/input"), require("./component/menu"), require("./component/paging"), require("./component/radio"), require("./component/search"), require("./component/select"), require("./component/slidebar"), require("./component/steps"), require("./component/switch"), require("./component/tab"), require("./component/table"), require("./component/testarea"), require("./component/toast"), require("./component/transfrom3D"), require("./lib/validator"));
	else
		root["slucky"] = factory(root["./component/checkbox"], root["./component/curmb"], root["./component/dialog"], root["./component/input"], root["./component/menu"], root["./component/paging"], root["./component/radio"], root["./component/search"], root["./component/select"], root["./component/slidebar"], root["./component/steps"], root["./component/switch"], root["./component/tab"], root["./component/table"], root["./component/testarea"], root["./component/toast"], root["./component/transfrom3D"], root["./lib/validator"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__component_checkbox__, __WEBPACK_EXTERNAL_MODULE__component_curmb__, __WEBPACK_EXTERNAL_MODULE__component_dialog__, __WEBPACK_EXTERNAL_MODULE__component_input__, __WEBPACK_EXTERNAL_MODULE__component_menu__, __WEBPACK_EXTERNAL_MODULE__component_paging__, __WEBPACK_EXTERNAL_MODULE__component_radio__, __WEBPACK_EXTERNAL_MODULE__component_search__, __WEBPACK_EXTERNAL_MODULE__component_select__, __WEBPACK_EXTERNAL_MODULE__component_slidebar__, __WEBPACK_EXTERNAL_MODULE__component_steps__, __WEBPACK_EXTERNAL_MODULE__component_switch__, __WEBPACK_EXTERNAL_MODULE__component_tab__, __WEBPACK_EXTERNAL_MODULE__component_table__, __WEBPACK_EXTERNAL_MODULE__component_testarea__, __WEBPACK_EXTERNAL_MODULE__component_toast__, __WEBPACK_EXTERNAL_MODULE__component_transfrom3D__, __WEBPACK_EXTERNAL_MODULE__lib_validator__) {
