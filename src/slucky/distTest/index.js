(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("./component/checkbox"), require("./component/curmb"), require("./component/dialog"), require("./component/input"), require("./component/menu"), require("./component/paging"), require("./component/progress"), require("./component/radio"), require("./component/search"), require("./component/select"), require("./component/slidebar"), require("./component/steps"), require("./component/switch"), require("./component/tab"), require("./component/table"), require("./component/textarea"), require("./component/toast"), require("./component/transfer"), require("./component/transfrom3D"), require("./component/tree"), require("./lib/validator"));
	else if(typeof define === 'function' && define.amd)
		define(["./component/checkbox", "./component/curmb", "./component/dialog", "./component/input", "./component/menu", "./component/paging", "./component/progress", "./component/radio", "./component/search", "./component/select", "./component/slidebar", "./component/steps", "./component/switch", "./component/tab", "./component/table", "./component/textarea", "./component/toast", "./component/transfer", "./component/transfrom3D", "./component/tree", "./lib/validator"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("./component/checkbox"), require("./component/curmb"), require("./component/dialog"), require("./component/input"), require("./component/menu"), require("./component/paging"), require("./component/progress"), require("./component/radio"), require("./component/search"), require("./component/select"), require("./component/slidebar"), require("./component/steps"), require("./component/switch"), require("./component/tab"), require("./component/table"), require("./component/textarea"), require("./component/toast"), require("./component/transfer"), require("./component/transfrom3D"), require("./component/tree"), require("./lib/validator")) : factory(root["./component/checkbox"], root["./component/curmb"], root["./component/dialog"], root["./component/input"], root["./component/menu"], root["./component/paging"], root["./component/progress"], root["./component/radio"], root["./component/search"], root["./component/select"], root["./component/slidebar"], root["./component/steps"], root["./component/switch"], root["./component/tab"], root["./component/table"], root["./component/textarea"], root["./component/toast"], root["./component/transfer"], root["./component/transfrom3D"], root["./component/tree"], root["./lib/validator"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(window, function(__WEBPACK_EXTERNAL_MODULE__component_checkbox__, __WEBPACK_EXTERNAL_MODULE__component_curmb__, __WEBPACK_EXTERNAL_MODULE__component_dialog__, __WEBPACK_EXTERNAL_MODULE__component_input__, __WEBPACK_EXTERNAL_MODULE__component_menu__, __WEBPACK_EXTERNAL_MODULE__component_paging__, __WEBPACK_EXTERNAL_MODULE__component_progress__, __WEBPACK_EXTERNAL_MODULE__component_radio__, __WEBPACK_EXTERNAL_MODULE__component_search__, __WEBPACK_EXTERNAL_MODULE__component_select__, __WEBPACK_EXTERNAL_MODULE__component_slidebar__, __WEBPACK_EXTERNAL_MODULE__component_steps__, __WEBPACK_EXTERNAL_MODULE__component_switch__, __WEBPACK_EXTERNAL_MODULE__component_tab__, __WEBPACK_EXTERNAL_MODULE__component_table__, __WEBPACK_EXTERNAL_MODULE__component_textarea__, __WEBPACK_EXTERNAL_MODULE__component_toast__, __WEBPACK_EXTERNAL_MODULE__component_transfer__, __WEBPACK_EXTERNAL_MODULE__component_transfrom3D__, __WEBPACK_EXTERNAL_MODULE__component_tree__, __WEBPACK_EXTERNAL_MODULE__lib_validator__) {
