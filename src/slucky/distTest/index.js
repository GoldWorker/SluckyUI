(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		var a = typeof exports === 'object' ? factory(require("./component/checkbox"), require("./component/curmb"), require("./component/dialog"), require("./component/input"), require("./component/menu"), require("./component/paging"), require("./component/progress"), require("./component/radio"), require("./component/search"), require("./component/select"), require("./component/slidebar"), require("./component/steps"), require("./component/switch"), require("./component/tab"), require("./component/table"), require("./component/text"), require("./component/textarea"), require("./component/toast"), require("./component/transfer"), require("./component/transfrom3D"), require("./component/tree"), require("./lib/validator")) : factory(root["./component/checkbox"], root["./component/curmb"], root["./component/dialog"], root["./component/input"], root["./component/menu"], root["./component/paging"], root["./component/progress"], root["./component/radio"], root["./component/search"], root["./component/select"], root["./component/slidebar"], root["./component/steps"], root["./component/switch"], root["./component/tab"], root["./component/table"], root["./component/text"], root["./component/textarea"], root["./component/toast"], root["./component/transfer"], root["./component/transfrom3D"], root["./component/tree"], root["./lib/validator"]);
